...
class MY_Loader extends CI_Loader {
	...
	public function view($template, $data = array(), $return = FALSE)
	{
		...
		*/
		...
		{
			show_error(htmlspecialchars_decode($e->getMessage()), 500, lang('error_template_error'));
		}
	...
	public function addTemplateDir($dir, $index = NULL)
	{
		$CI =& get_instance();
		$CI->smartytpl->addTemplateDir($dir, $index);
	}
}
